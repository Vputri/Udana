                  ...
                  <div class="col-md-4">
                    <div class="row">
                      ...
                      <div class="col-md-6 size12">
                        <span className="text-muted">Jl. KH. Hasyim Ashari No.17, Petojo Utara, Kecamatan Gambir,
                        Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta, 10130</span>
                        <p>E: support@udana.id</p>
                        <span>W: 087709999430</span>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="row">
                      <div class="col-md-6">
                        <ul className="list-unstyled">
                          <p className="text-muted">Perusahaan</p>
                          <li>
                            <a className="text-reset text-decoration-none size13" href="/ComingSoon">
                              Tentang
                            </a>
                          </li>
                          <li>
                      ...
                      <div class="col-md-6">
                        <ul className="list-unstyled">
                          <p className="text-muted">Investor</p>
                          <li>
                            <a className="text-reset text-decoration-none size13" href="/ComingSoon">
                              FAQ
                            </a>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div>
                          ...
                          <span className="mx-2">
                            <a href="https://www.linkedin.com/company/udana-id/" target="_blank">
                      ...
                      <div class="col-md-6">
                        <p className="text-muted">Didukung oleh</p>
                        <div class="row">
                          <div class="col">
                            <a href="https://pse.kominfo.go.id/tdpse-detail/1425" target="_blank">
                              <img src={logo}/>
                            </a>
                          </div>
                          <div class="col">
                            <a href="https://pse.kominfo.go.id/tdpse-detail/1677" target="_blank">
                              <img src={logo1}/>
                            </a>
                          </div>
                          <div class="col">
                            <a href="https://aludi.id/" target="_blank">
                              <img src={logo2}/>
                            </a>
                          </div>
                        </div>
                        <div class="row">
                            <a href="https://www.cbqaglobal.com/validation/company/pt-dana-rintis-indonesia/?cred_referrer_form_id=58" target="_blank">
                              <img src={logo3}/>
                            </a>
                        </div>
                      </div>
